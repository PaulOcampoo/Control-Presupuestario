...
const PERMISSIONS = {
  admin: { label: 'Administrador', tabs: ['resumen', 'contrato', 'insumos', 'requisiciones', 'ordenes', 'avance', 'programa', 'destajo', 'usuarios', 'proveedores', 'finanzas', 'mapeo'] },
  residente: { label: 'Residente', tabs: ['contrato', 'insumos', 'requisiciones', 'ordenes', 'avance', 'destajo', 'finanzas'] },
