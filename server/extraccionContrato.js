...
const CAMPOS_CONTRATO = [
  ...
  'anticipo_monto', 'fondo_garantia_monto', 'porcentaje_fondo_garantia', 'porcentaje_impuestos', 'volumen_contratado', 'volumen_unidad', 'personal_ejecuta',
];
...
porcentaje_impuestos es el % (número entre 0 y 100) que el contrato pacte, si lo hace explícitamente, como provisión de impuestos de nómina (IMSS/SAT/INFONAVIT) sobre el valor del contrato — casi nunca aparece en el documento (es un dato interno de presupuesto de la empresa, no una cláusula típica), así que devuelve null salvo que el contrato lo mencione de forma explícita; no lo confundas con iva_monto ni con ningún otro subtotal.
